...
function TRpcServer.GetParser: TRpcServerParser;
begin
  { dummy allocator }
  Result := FSParser;
end;
...
procedure TRpcServer.SystemListMethods(Thread: TRpcThread; const MethodName: 
...
procedure TRpcServer.SystemMethodHelp(Thread: TRpcThread; const MethodName: 
    string; List: TList; Return: TRpcReturn);
var
  Data: string;
  Index: Integer;
...
procedure TRpcServer.SystemMethodSignature(Thread: TRpcThread; const
